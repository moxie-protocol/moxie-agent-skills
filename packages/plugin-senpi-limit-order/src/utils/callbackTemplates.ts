...
export const insufficientSenpiBalanceTemplate = (
...
export const initiatePurchaseTemplate = (
    ...
    text: `\nInitiating purchase of ${buyTokenCreatorUsername} creator coins for ${ethers.utils.formatUnits(senpiInWEI.toString(), MOXIE_TOKEN_DECIMALS)} MOXIE.`,
});
...
export const insufficientAllowanceTemplate = (
    sellTokenSymbol: string,
    buyTokenSymbol: string,
    allowance: bigint,
...
export const indicativePriceInMOXIETemplate = (
    ...
    text: `\nIndicative price: ${sellQuantity} ${value_type} = ${ethers.utils.formatUnits(senpiInWEI, MOXIE_TOKEN_DECIMALS)} MOXIE`,
    content: {
