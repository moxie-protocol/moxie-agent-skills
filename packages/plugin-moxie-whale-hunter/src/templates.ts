...
- Mention the traders by name and link to them using the markdown format:  [username](https://moxie.xyz/profile/user_id) format e.g. [betashop.eth](https://moxie.xyz/profile/M4). If username is not available, use following format: [user_id](https://moxie.xyz/profile/user_id) e.g. [M4](https://moxie.xyz/profile/M4)
