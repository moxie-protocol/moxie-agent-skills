...
- For each token in the summary, always include:
	...
	- Notable Senpi users who swapped the token. Mention them by name and link to them using the markdown format:  [username](https://senpi.ai/profile/user_id) format
