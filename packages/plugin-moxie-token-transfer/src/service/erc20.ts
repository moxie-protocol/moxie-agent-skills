 ...
 */
export async function decodeTokenTransfer(moxieUserId: string, txReceipt: ethers.TransactionReceipt, buyTokenAddress: string, agentWalletAddress: string): Promise<{ amount: string, from: string, to: string } | null> {
    try {
